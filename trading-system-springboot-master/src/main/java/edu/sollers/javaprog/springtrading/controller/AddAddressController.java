...
public class AddAddressController {
	 ...
	 * <ul>
	 * <li>if address already exists in table, set that address's id to account's
	 * address</li>
	 ...
	 * <ul>
	 * <li>if mailing address already exists in table, set that address id to
	 * account's mailing address</li>
	 * <li>else create new address and set that address id to account's mailing
	 * address</li>
	 * </ul>
	 * </li>
	 * </ul>
